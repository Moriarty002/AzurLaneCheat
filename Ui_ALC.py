...
class Ui_AzurLaneCheater(object):
    def setupUi(self, AzurLaneCheater):
        ...
        self.pushButton = QtWidgets.QPushButton(AzurLaneCheater)
        ...
        self.pushButton_2 = QtWidgets.QPushButton(AzurLaneCheater)
    ...
    def retranslateUi(self, AzurLaneCheater):
        ...
        self.pushButton.setText(_translate("AzurLaneCheater", "confirm"))
        ...
        self.pushButton_2.setText(_translate("AzurLaneCheater", "close"))
